...
- LOCAL: git-diff-reviewer agent (Claude) + codex:codex-rescue agent (Codex -- do not name a model in the dispatch prompt; the codex CLI's configured default applies)
